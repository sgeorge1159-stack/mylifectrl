...
const SEO_TITLE = 'Log In — MyCTRL™ | Your AI Personal Chief of Staff';
const SEO_DESC =
  'Log in to your MyCTRL account and continue your personalized action plan. Your AI-powered personal chief of staff is ready.';
