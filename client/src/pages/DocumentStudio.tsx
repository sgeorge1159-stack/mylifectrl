      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-calm-500 max-w-md mx-auto">
            Upload your first document — bills, letters, pay stubs, screenshots, emails, or any paperwork you need organized. MyCTRL's AI will categorize and summarize it for you.
          </p>
        </div>
      ) : viewMode === 'grid' ? (
      ...
      {docs.length > 0 && (
        <div className="mt-8 text-center">
          <p className="text-calm-500 text-sm">
            Upload emails, screenshots, PDFs, and letters — MyCTRL's AI will organize them into structured, searchable records.
          </p>
        </div>
      )}
    </div>
